...
DEF SPRITE_POKEMON EQU const_value
	...
	const SPRITE_MURKROW ; a3
	const SPRITE_ELECTRODE ; a4
	const SPRITE_GASTLY ; a5
	const SPRITE_HAUNTER ; a6
	const SPRITE_CHANSEY ; a7
	const SPRITE_MILTANK ; a8
	const SPRITE_RATTATA
	const SPRITE_SANDSHREW
	const SPRITE_PIDGEY
	const SPRITE_BELLSPROUT
	const SPRITE_SEEL
	const SPRITE_BEEDRILL
	const SPRITE_PSYDUCK
	const SPRITE_SCYTHER
	const SPRITE_PONYTA
	const SPRITE_KADABRA
	...
	const SPRITE_PHANPY
	const SPRITE_PICHU
	const SPRITE_HOOTHOOT
	const SPRITE_NATU
	const SPRITE_WOOPER
	const SPRITE_MAREEP
	const SPRITE_IGGLYBUFF
	const SPRITE_LEDIAN
	const SPRITE_YANMA
	const SPRITE_GIRAFARIG
