...
ClairGroup:
	...
	db 48, GYARADOS,   DRAGONBREATH, WATERFALL, WHIRLPOOL, RAIN_DANCE
	db 47, DRAGONAIR,  SAFEGUARD, THUNDER, WRAP, DRAGONBREATH
	db 47, MAGCARGO,   AMNESIA, FLAMETHROWER, ROCK_SLIDE, MAGNITUDE
	db 48, CHARIZARD,  FIRE_BLAST, IRON_TAIL, OUTRAGE, SLASH
	db 50, KINGDRA,    AGILITY, HYDRO_PUMP, THUNDER, OUTRAGE
	db -1 ; end
...
;and for the RIVAL, Larvitar, CELEBI, MEW
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, THUNDER_WAVE,NO_MOVE
	...
	db 35, MAGNETON,   THUNDERSHOCK, THUNDER_WAVE, SWIFT, NO_MOVE
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, THUNDER_WAVE, SWIFT, NO_MOVE
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
...
ChampionGroup:
	...
	db 60, GYARADOS,   THUNDER, RAIN_DANCE, SURF, HYPER_BEAM
	db 61, LAPRAS,     BLIZZARD, DRAGONBREATH, THUNDER, SURF
	db 62, SNORLAX,    REST, AMNESIA, EARTHQUAKE, HYPER_BEAM
	db 63, AERODACTYL, SKY_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 64, CHARIZARD,  FLAMETHROWER, SKY_ATTACK, EARTHQUAKE, HYPER_BEAM
...
CooltrainerMGroup:
	...
	db 35, FLAREON,    QUICK_ATTACK, BITE, FIRE_SPIN, NO_MOVE
	db -1 ; end
	...
	db 25, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, NO_MOVE
	...
	db 32, FLAREON,    QUICK_ATTACK, BITE, FIRE_SPIN, NO_MOVE
	db -1 ; end
	...
	db 35, SANDSLASH,  POISON_STING, SLASH, SWIFT, NO_MOVE
	db -1 ; end
...
HikerGroup:
	...
	db 27, DIGLETT,    MAGNITUDE, DIG, SLASH, NO_MOVE
	db 27, DUGTRIO,    MAGNITUDE, DIG, SLASH, NO_MOVE
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 50, MURKROW,    DRILL_PECK, SKY_ATTACK, PURSUIT, SWIFT
	db -1 ; end
