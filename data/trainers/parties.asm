...
WhitneyGroup:
	...
	db 24, RATICATE,   HYPER_FANG, FOCUS_ENERGY, BITE, QUICK_ATTACK
	db 22, CLEFAIRY,   POUND, MIMIC, ENCORE, METRONOME
	db 20, JIGGLYPUFF, PIXIE_DUST, SING, DEFENSE_CURL, ROLLOUT
	db 22, GIRAFARIG,  STOMP, CONFUSION, AGILITY, TACKLE
