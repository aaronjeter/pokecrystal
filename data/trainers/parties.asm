...
MortyGroup:
	...
	db 27, MISDREAVUS, LICK, SPITE, CONFUSE_RAY, NIGHT_SHADE
	db 25, HAUNTER,    LICK, SPITE, MEAN_LOOK, CURSE
	db 25, VULPIX,     LICK, HYPNOSIS, EMBER, ROAR
	db 28, MAROWAK,    BONEMERANG, HEADBUTT, LICK, FOCUS_ENERGY
...
KarenGroup:
	...
	db 42, UMBREON,    CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK, NO_MOVE
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, THUNDER, ROLLOUT, NO_MOVE
	db -1 ; end
