...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL,        90, 10,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          20, NORMAL,        90, 15,   0
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         80, NORMAL,        90, 20,   0
	move PAY_DAY,      EFFECT_PAY_DAY,            40, NORMAL,       100, 20,   0
	move FIRE_PUNCH,   EFFECT_NORMAL_HIT,         60, FIRE,         100, 15,  10
	move ICE_PUNCH,    EFFECT_NORMAL_HIT,         60, ICE,          100, 15,  10
	move THUNDERPUNCH, EFFECT_NORMAL_HIT,         60, ELECTRIC,     100, 15,  10
	move SCRATCH,      EFFECT_NORMAL_HIT,         40, NORMAL,       100, 35,   0
	move VICEGRIP,     EFFECT_NORMAL_HIT,         85, STEEL,        100, 15,   0
	move GUILLOTINE,   EFFECT_DEFENSE_DOWN_HIT,  120, STEEL,         80,  5, 100
	move RAZOR_WIND,   EFFECT_DEFENSE_DOWN_HIT,   70, FLYING,       100, 15,  50
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_DEFENSE_DOWN_HIT,   75, STEEL,        100, 15,  50
	...
	move BIND,         EFFECT_TRAP_TARGET,        25, NORMAL,       100, 20,   0
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,          80, FIGHTING,      90, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, FIGHTING,      85, 15,  10
	...
	move TACKLE,       EFFECT_FLINCH_HIT,         35, NORMAL,       100, 35,  10
	...
	move FAE_VOICE,    EFFECT_FLINCH_HIT,         55, FAIRY,        100, 20,  20
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        55, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   35, POISON,       100, 30,  25
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,           90,  5,  10
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        200, NORMAL,        90,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         40, FLYING,       100, 35,   0
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, FLYING,       100, 20,   0
	move SUBMISSION,   EFFECT_RECOIL_HIT,        120, FIGHTING,     100, 10,   0
	...
	move STRENGTH,     EFFECT_FLINCH_HIT,        100, ROCK,          90, 15,  25
	...
	move STRING_SHOT,  EFFECT_SPEED_DOWN_HIT,     30, BUG,           95, 40,  50
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      40, DRAGON,       100, 10,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        50, FIRE,         100, 15,   0
	...
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,         85, GROUND,       100, 10,   0
	move FISSURE,      EFFECT_NORMAL_HIT,        120, GROUND,        80,  5,   0
	move DIG,          EFFECT_FLY,               100, GROUND,        95, 10,   0
	move TOXIC,        EFFECT_TOXIC,               0, POISON,        85, 10,   0
	move CONFUSION,    EFFECT_CONFUSE_HIT,        40, PSYCHIC_TYPE,  95, 25,  10
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    80, PSYCHIC_TYPE, 100, 10,  25
	...
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,          85,  5,  50
	move WATERFALL,    EFFECT_SP_DEF_DOWN_HIT,    75, WATER,        100, 15,  50
	...
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          25, STEEL,        100, 15,   0
	...
	move SKY_ATTACK,   EFFECT_NORMAL_HIT,        120, FLYING,        80,  5,   0
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,       100, 10,   0
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     30, WATER,        100, 30,  50
	...
	move ROCK_SLIDE,   EFFECT_NORMAL_HIT,         90, ROCK,          90, 10,  30
	...
	move SLASH,        EFFECT_NORMAL_HIT,         80, NORMAL,       100, 20,   0
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      65,  5, 100
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     60, STEEL,         95, 25,  10
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       75, DRAGON,       100, 20,  25
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,         75, FIGHTING,     100, 10,   0
	...
	move CRUNCH,       EFFECT_SP_DEF_DOWN_HIT,    80, DARK,         100, 15,  25
